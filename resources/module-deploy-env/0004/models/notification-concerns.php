...
return [
    ...
    "data"      => [
        ...
        [
            "is_enabled"                         => true,
            "reason_code"                        => NotificationConcern::REASON_CODE_USER_ASSIGNED_TO_TRADER,
            "notificationTemplate.code"                 => NotificationConcern::REASON_CODE_USER_ASSIGNED_TO_TRADER,
            "notificationTemplate.notification_channel" => "email",
            "sender"                             => '',
        ...
        [
            "is_enabled"                         => true,
            "reason_code"                        => NotificationConcern::REASON_CODE_USER_ASSIGNED_TO_ACL_GROUP,
            "notificationTemplate.code"                 => NotificationConcern::REASON_CODE_USER_ASSIGNED_TO_ACL_GROUP,
            "notificationTemplate.notification_channel" => "email",
            "sender"                             => '',
