...
class Product extends ModelBaseExtraAttributes
{
    ...
    public function getFormElements(): array
    {
        ...
        $extraAttributeTab['visible'] = $this->viewModeAtLeast();
        ...
        return [
            ...
            'tab_controls' => [
                'base_item' => [
                    ...
                    'tab_pages' => [
                        'common_simple' => [
                            'visible' => $this->viewModeAtMaximum(NativeObjectBase::viewModeSimple),
                            'tab'     => [
                                'label' => __('Common'),
                            ],
                            'content' => [
                        ...
                        'common'        => [
                            ...
                            'content' => [
                                'form_elements' => [
                                    ...
                                    'shipping_method_id'     => $formService->getFormElement(ExtraAttributeModel::ATTR_SHIPPING_METHOD),
                                    'started_at'             => [
                                        'visible'      => $this->viewModeAtLeast(NativeObjectBase::viewModeExtended),
                                    ...
                                    'rating5'                => [
                                        ...
                                        'visible'      => $productRatingVisible && $this->viewModeAtLeast(NativeObjectBase::viewModeExtended),
